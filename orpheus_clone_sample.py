...
def load_orpheus_tokenizer(model_id: str = "canopylabs/orpheus-3b-0.1-pretrained") -> AutoTokenizer:
...
def load_orpheus_auto_model(model_id: str = "canopylabs/orpheus-3b-0.1-pretrained"):
